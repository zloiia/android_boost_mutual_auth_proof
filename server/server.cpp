...
public:
    ...
    context_(io_service, boost::asio::ssl::context::sslv23) {
        ...
        context_.use_certificate_chain_file("certs/ca.crt");
        context_.use_rsa_private_key_file("certs/ca.key", boost::asio::ssl::context::pem);
        
        /**
         * verify client auth
         */
        context_.set_verify_mode(boost::asio::ssl::context::verify_fail_if_no_peer_cert | boost::asio::ssl::context::verify_peer);
        context_.load_verify_file("certs/ca.crt");
